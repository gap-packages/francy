...
export { RenderingManager, RENDERING_EVENTS } from './src/render/rendering-manager';
...
export { default as Menu } from './src/render/menu/menu';
export { default as Modal } from './src/render/modal/modal';
export { default as AboutModal } from './src/render/modal/modal-about';
