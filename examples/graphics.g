...
box2:=Box(canvas, 30, 30, 20, 20, rec(color:="Green", name:="box2", draggable:=true));
box3:=Box(canvas, 60, 60, 20, 20, rec(color:="Red", name:="box2", draggable:=true));
...
circle2:=Circle(canvas, 100, 100, 20, rec(color:="Green", name:="circle2", draggable:=true)););
