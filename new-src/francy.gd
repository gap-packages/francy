...
#############################################################################
##
#C  IsLine( <gobj> ) . . . . . . . . . . . category of graphic boxes
##
DeclareCategory( "IsLine", IsGraphicObject );
...
DeclareRepresentation( "IsGraphicCanvasRep",
    ...
    [ "name", "width", "height", "objects" ], IsGraphicCanvas );
...
DeclareRepresentation( "IsBoxObjectRep",
    IsGraphicObjectRep, [ "id", "x", "y", "w", "h" ], IsGraphicObject );
...
DeclareRepresentation( "IsLineObjectRep",
    IsGraphicObjectRep, [ "id", "points", "width" ], IsGraphicObject );